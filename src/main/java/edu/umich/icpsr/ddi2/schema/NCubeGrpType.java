...
@XmlType(name = "nCubeGrpType", namespace = "ddi:codebook:2_5", propOrder = {
    "labl",
    "txt",
    "concept",
    "defntn",
    ...
    extends BaseElementType
{
    ...
    protected List<Object> nCube;
    @XmlAttribute(name = "nCubeGrp")
    @XmlIDREF
    @XmlSchemaType(name = "IDREFS")
    protected List<Object> nCubeGrp;
     ...
     * 
     */
    public List<Object> getNCube() {
        if (nCube == null) {
            nCube = new ArrayList<Object>();
        }
        return this.nCube;
    }
     ...
     * 
     */
    public List<Object> getNCubeGrp() {
        if (nCubeGrp == null) {
            nCubeGrp = new ArrayList<Object>();
        }
